  ...
  header: {
    'pt-br': `
      <header>
        ...
        <button class="menu-toggle" type="button" aria-label="Abrir menu" aria-controls="mobile-menu" aria-expanded="false" onclick="toggleMenu()"><span></span></button>
    ...
    en: `
      <header>
        <a href="#" class="logo" data-nav-target="home">brandao.sn <span class="logo-badge">BETA</span></a>
        <button class="menu-toggle" type="button" aria-label="Open menu" aria-controls="mobile-menu" aria-expanded="false" onclick="toggleMenu()"><span></span></button>
